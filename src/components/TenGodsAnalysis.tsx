...
// 柱位解讀
const PILLAR_MEANINGS: Record<string, { area: string; age: string; relation: string }> = {
  year: { area: '祖業、社會', age: '1-16歲', relation: '祖父母、長輩' },
  month: { area: '事業、父母', age: '17-32歲', relation: '父母、兄弟' },
  day: { area: '自己、配偶', age: '33-48歲', relation: '配偶、自身' },
  hour: { area: '子女、晚年', age: '49歲以後', relation: '子女、後輩' },
};

// 十神在不同柱位的詳細解讀
const TEN_GODS_PILLAR_MEANINGS: Record<string, Record<string, string>> = {
  '比肩': {
    year: '祖上有兄弟姐妹助力，或有合作關係。幼年獨立性強，可能較早離家。',
    month: '與兄弟姐妹關係良好，青年期有朋友助力。事業上適合合夥或團隊合作。',
    day: '（日支為配偶宮）配偶個性獨立，有主見，夫妻間需相互尊重。',
    hour: '子女獨立自主，晚年有朋友陪伴，社交活躍。',
  },
  '劫財': {
    year: '祖上可能有財產爭奪。幼年家境起伏，需學會理財。',
    month: '青年期競爭激烈，需防小人。與兄弟姐妹有財務糾紛的可能。',
    day: '配偶花錢較大方，夫妻間需財務分明。婚姻需防第三者。',
    hour: '晚年開銷較大，需提早規劃養老。子女花費較多。',
  },
  '食神': {
    year: '祖上有藝術或技術傳承。童年快樂，有口福。',
    month: '青年期才華展現，有藝術天賦。事業上適合創作類工作。',
    day: '配偶溫和好相處，婚姻生活愉快。有美食緣分。',
    hour: '子女有才華，晚年享清福。有口福，生活愜意。',
  },
  '傷官': {
    year: '祖上有叛逆或創新之人。童年個性鮮明，可能與長輩意見不合。',
    month: '青年期表達欲強，可能與上司有衝突。適合自主性強的工作。',
    day: '配偶聰明有個性，婚姻中需要溝通。女命婚姻需注意。',
    hour: '子女聰明但個性強，晚年可能與子女意見不同。',
  },
  '正財': {
    year: '祖上有穩定產業。童年家境不錯，有物質基礎。',
    month: '青年期財運穩定，工作收入好。事業上穩紮穩打。',
    day: '男命妻緣佳，配偶持家有方。婚姻穩定和諧。',
    hour: '晚年財運好，子女孝順。有穩定的養老保障。',
  },
  '偏財': {
    year: '祖上有經商或投資傳統。童年可能有意外之財或禮物。',
    month: '青年期有投資運，適合做生意。可能有兼職或副業收入。',
    day: '男命異性緣佳，需注意感情。配偶可能帶財。',
    hour: '晚年有意外之財，但也要防投資風險。子女有經商能力。',
  },
  '正官': {
    year: '祖上有公職或受人尊敬。童年受嚴格教育，守規矩。',
    month: '青年期事業運好，適合體制內發展。有升遷機會。',
    day: '女命丈夫運佳，配偶有責任感。婚姻受禮法約束。',
    hour: '晚年受人尊敬，子女有出息。名聲好，地位穩。',
  },
  '七殺': {
    year: '祖上有軍人或強勢人物。童年可能遭遇壓力或挑戰。',
    month: '青年期面對激烈競爭，需要魄力突圍。適合挑戰性工作。',
    day: '配偶個性強勢，婚姻中有壓力。需要磨合與妥協。',
    hour: '晚年仍有壓力，子女可能較強勢。需注意健康。',
  },
  '正印': {
    year: '祖上有文化人或受良好教育。童年受呵護，有學習機會。',
    month: '青年期學業運好，有貴人提攜。適合文教類工作。',
    day: '配偶善解人意，婚姻有溫暖。有母親緣。',
    hour: '晚年有依靠，子女孝順。精神生活豐富。',
  },
  '偏印': {
    year: '祖上有特殊才能或偏門技藝。童年思想早熟，想法獨特。',
    month: '青年期有獨特才華，適合研究或特殊領域。直覺強。',
    day: '配偶思維獨特，婚姻需要理解。可能有玄學緣分。',
    hour: '晚年精神世界豐富，子女有獨特才能。可能較孤獨。',
  },
};
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-muted-foreground">{pillarMeaning?.age}</span>
                    </div>
