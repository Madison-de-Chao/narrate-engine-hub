...
const Footer = () => {
  ...
  return (
    <footer className={`
      relative py-12 px-4 sm:px-6 border-t
      ${theme === 'dark' 
    ...
    `}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link 
                  to="/map" 
                  className={`text-sm transition-colors hover:text-amber-500 inline-flex items-center gap-1 ${
                    theme === 'dark' ? 'text-paper/60' : 'text-void/60'
                  }`}
                >
          ...
          <div className="space-y-4">
            ...
            <a 
              ...
              className={`text-sm transition-colors hover:text-amber-500 inline-flex items-center gap-2 ${
                theme === 'dark' ? 'text-paper/60' : 'text-void/60'
              }`}
            >
        ...
        {/* Disclaimer */}
        <div className={`
          py-6 px-4 rounded-lg mb-8 text-center
        ...
        `}>
          <p className={`text-xs ${
            ...
            © {currentYear} 虹靈御所 Hong Ling Yu Suo. All rights reserved.
          </p>
