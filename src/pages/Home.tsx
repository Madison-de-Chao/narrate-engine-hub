  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="cosmic-grid opacity-30" />
      </div>
      ...
      <section className="relative pt-8 sm:pt-12 pb-12 sm:pb-20 px-4 sm:px-6">
        ...
        >
          ...
          <motion.h1 
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold font-serif mb-4 sm:mb-6 leading-tight text-center text-foreground"
          >
            <span className="cosmic-title-gradient">
              八字命盤
            </span>
            <br />
          ...
          <motion.p 
            variants={itemVariants}
            className="text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-6 sm:mb-10 leading-relaxed px-2 text-muted-foreground"
          >
          ...
          >
            <Button
              ...
              className="
                ...
                bg-gradient-to-r from-primary via-cosmic-gold-bright to-accent 
            ...
            {!loading && !user && (
              <Button
                ...
                className="w-full sm:w-auto px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg border-border text-foreground hover:bg-muted"
              >
          ...
          >
            {features.map((feature, index) => (
              <motion.div key={index} variants={itemVariants}>
                <Card className="h-full transition-all duration-300 hover:scale-[1.02] sm:hover:scale-105 hover:shadow-lg bg-card/60 border-border/50 hover:border-primary/30">
      ...
      <section className="relative py-10 sm:py-16 px-4 sm:px-6">
        ...
        >
          <Card className="bg-gradient-to-br from-card/80 to-muted/60 border-primary/20">
            <CardContent className="p-5 sm:p-8 md:p-10">
              <Star className="w-8 h-8 sm:w-10 sm:h-10 mx-auto mb-4 sm:mb-6 text-primary" />
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold font-serif mb-4 sm:mb-6 text-center text-foreground">
                信任與方法
              </h2>
              <div className="space-y-4 sm:space-y-5 text-sm sm:text-base md:text-lg leading-relaxed text-foreground/80">
                ...
                <p className="text-xs sm:text-sm text-center pt-2 sm:pt-4 text-muted-foreground">
      ...
      <section className="relative py-10 sm:py-16 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold font-serif mb-3 sm:mb-4 text-foreground">
              應用場景
            </h2>
            <p className="text-sm sm:text-base max-w-xl mx-auto text-muted-foreground">
          ...
          {isMobile ? (
            <div className="relative">
                ...
                <div className="flex">
                  {testimonials.map((testimonial, index) => (
                    <div key={index} className="flex-[0_0_85%] min-w-0 pl-4 first:pl-0">
                      <Card className="h-full transition-all duration-300 bg-card/60 border-border/50">
                        <CardContent className="p-5">
                          ...
                          <Quote className={`w-6 h-6 mb-2 ${testimonial.quoteColor}`} />
              ...
              <button
                onClick={scrollPrev}
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 w-8 h-8 rounded-full flex items-center justify-center transition-colors bg-card/80 text-foreground/70 hover:bg-muted"
                aria-label="上一個"
              >
              ...
              <button
                onClick={scrollNext}
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 w-8 h-8 rounded-full flex items-center justify-center transition-colors bg-card/80 text-foreground/70 hover:bg-muted"
                aria-label="下一個"
              >
            ...
            >
              {testimonials.map((testimonial, index) => (
                <motion.div key={index} variants={itemVariants}>
                  <Card className="h-full transition-all duration-300 hover:shadow-lg bg-card/60 border-border/50 hover:border-primary/30">
        ...
        >
          <Card className="bg-gradient-to-br from-card/80 to-muted/60 border-primary/20">
            <CardContent className="p-5 sm:p-8 md:p-10 text-center">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold font-serif mb-4 sm:mb-6 text-foreground">
                品牌核心理念
              </h2>
              <div className="space-y-3 sm:space-y-4 text-sm sm:text-base md:text-lg leading-relaxed text-foreground/80">
                <p className="quote-classical text-base sm:text-lg md:text-xl px-2">
                  「這份分析是鏡子，不是劇本：提供視角與路徑，但選擇權永遠在你手上。」
                </p>
                <div className="pt-3 sm:pt-4 flex flex-wrap justify-center gap-2 sm:gap-3 text-xs sm:text-sm text-muted-foreground">
                  <Badge variant="outline" className="border-primary/40 text-xs">✓ 清楚</Badge>
                  <Badge variant="outline" className="border-primary/40 text-xs">✓ 克制</Badge>
                  <Badge variant="outline" className="border-primary/40 text-xs">✓ 有美感</Badge>
                  <Badge variant="outline" className="border-primary/40 text-xs">✓ 可執行</Badge>
                </div>
                <p className="text-xs sm:text-sm pt-2 sm:pt-4 text-muted-foreground">
      ...
      <section className="relative py-12 sm:py-20 px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-sm sm:text-base mb-6 sm:mb-8 text-muted-foreground">
