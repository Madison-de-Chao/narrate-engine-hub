...
【兵符規則 - 強制執行】
兵符是命盤中的特殊符號（傳統稱為神煞），必須在故事中具體呈現：
- 每個兵符都必須以「事件」或「角色特質」的形式出現
- 兵符名稱首次出現時用括號標註
- 吉符（如天乙貴人、文昌貴人）：化為貴人相助、智慧啟發等正面事件
- 凶符（如華蓋、孤辰）：化為考驗、獨處時刻等情境
- 禁止只在結尾一筆帶過，必須融入第二段的核心事件中

兵符融入範例：
❌ 錯誤：「幸好有天乙貴人相助，事情順利解決。」（太籠統）
✅ 正確：「正當僵局無解之際，一位白袍老者（天乙貴人兵符）悄然出現，他輕聲提點了幾句，將軍頓時豁然開朗。」
...
範例一（含兵符解釋）：
老兵低聲對年輕士兵說：「你看到那位白袍老者了嗎？那就是傳說中的天乙貴人兵符。只要將軍遇到真正的困難，總會有貴人在暗中相助。這是他命中注定的福報。」

範例二：
年輕士兵問：「為什麼將軍總喜歡獨自一人待著？」
老兵說：「那是因為他帶著華蓋兵符。這讓他擁有非凡的洞察力和藝術天賦，但也讓他習慣獨處，不太融入人群。」
